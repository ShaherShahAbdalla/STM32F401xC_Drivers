 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuSelectPLLsSrc(uint32_t Copy_u32PLLSrc);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuGetPLLsSrc(uint32_t* Add_u32PLLSrc);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuConfigMainPLL(uint32_t Copy_u32PLLM, uint32_t Copy_u32PLLN, uint32_t Copy_u32PLLP, uint32_t Copy_u32PLLQ);
...
// *@return: Error status.
// */
//RCC_enuErrorStatus_t RCC_enuConfigPLLM(uint32_t Copy_u32PLLM);
//
//
///**
...
// *@return: Error status.
// */
//RCC_enuErrorStatus_t RCC_enuConfigPLLN(uint32_t Copy_u32PLLN);
//
//
///**
...
// *@return: Error status.
// */
//RCC_enuErrorStatus_t RCC_enuConfigPLLP(uint32_t Copy_u32PLLP);
//
//
///**
...
// *@return: Error status.
// */
//RCC_enuErrorStatus_t RCC_enuConfigPLLQ(uint32_t Copy_u32PLLQ);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuConfigPLLI2SN(uint32_t Copy_u32PLLM, uint32_t Copy_u32PLLI2SN, uint32_t Copy_u32PLLI2SR);
...
// *@return: Error status.
// */
//RCC_enuErrorStatus_t RCC_enuConfigPLLI2SN(uint32_t Copy_u32PLLI2SN);
//
//
///**
...
// *@return: Error status.
// */
//RCC_enuErrorStatus_t RCC_enuConfigPLLI2SR(uint32_t Copy_u32PLLI2SR);
/**************************************************************************************/
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuSelectSysClk(uint32_t Copy_u32SysClk);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuGetSysClk(uint32_t* Add_u32SysClk);
/**************************************************************************************/
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuEnableAHB1Peripheral(uint32_t Copy_u32AHB1Peripheral);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuDisableAHB1Peripheral(uint32_t Copy_u32AHB1Peripheral);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuEnableAHB2Peripheral(uint32_t Copy_u32AHB2Peripheral);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuDisableAHB2Peripheral(uint32_t Copy_u32AHB2Peripheral);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuEnableAPB1Peripheral(uint32_t Copy_u32APB1Peripheral);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuDisableAPB1Peripheral(uint32_t Copy_u32APB1Peripheral);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuDisableAPB2Peripheral(uint32_t Copy_u32APB2Peripheral);
/**************************************************************************************/
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuConfigAHBPRES(uint32_t Copy_u32AHBPRES);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuConfigAPB1PRES(uint32_t Copy_u32APB1PRES);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuConfigAPB2PRES(uint32_t Copy_u32APB2PRES);
 ...
 *@return: Error status.
 */
RCC_enuErrorStatus_t RCC_enuConfigTimersPRES(uint32_t Copy_u32TIMsPRES);
