...
typedef struct {
	...
	uint32_t NVIC_Reserved1[24];
	volatile uint32_t ICER[8];
	uint32_t NVIC_Reserved2[24];
	volatile uint32_t ISPR[8];
	uint32_t NVIC_Reserved3[24];
	volatile uint32_t ICPR[8];
	uint32_t NVIC_Reserved4[24];
	volatile uint32_t IABR[8];
	uint32_t NVIC_Reserved5[56];
	volatile uint8_t IPR[240];
	uint32_t NVIC_Reserved6[644];
 ...
 *@return: Error status.
 */
NVIC_enuErrorStatus_t NVIC_GetPendingIRQ(IRQs_t IRQ_, uint32_t* pendingStatus)
{
	NVIC_enuErrorStatus_t LOC_enuErrorStatus = NVIC_enuOk;
 ...
 *@return: Error status.
 */
NVIC_enuErrorStatus_t NVIC_GetActiveStatusIRQ(IRQs_t IRQ_, uint32_t* activeStatus)
{
	NVIC_enuErrorStatus_t LOC_enuErrorStatus = NVIC_enuOk;
 ...
 *@return: Error status.
 */
NVIC_enuErrorStatus_t NVIC_SetPriorityIRQ(IRQs_t IRQ_, uint8_t PREEMPTION_LEVEL_, uint8_t SUBPRIORITY_LEVEL_)
{
	NVIC_enuErrorStatus_t LOC_enuErrorStatus = NVIC_enuOk;
 ...
 *@return: Error status.
 */
NVIC_enuErrorStatus_t NVIC_GetPriorityIRQ(IRQs_t IRQ_, uint8_t* priorityLevel)
{
	NVIC_enuErrorStatus_t LOC_enuErrorStatus = NVIC_enuOk;
...
NVIC_enuErrorStatus_t NVIC_GenerateSoftwareIRQ(IRQs_t IRQ_)
{
	...
	else
	{
		...
		/* Create a local variable as an image of the real register */
		uint32_t LOC_u32LocalReg = NVIC->STIR;
		/* Clean the bits before assigning in it */
 ...
 *@return: Error status.
 */
NVIC_enuErrorStatus_t NVIC_SetPriorityGrouping(uint32_t priorityGroup)
{
	NVIC_enuErrorStatus_t LOC_enuErrorStatus = NVIC_enuOk;
	...
	else
	{
		...
		/* Create a local variable as an image of the real register */
		uint32_t LOC_u32LocalReg = SCB->AIRCR;
		/* Clean the bits before assigning in it */
 ...
 *@return: Error status.
 */
NVIC_enuErrorStatus_t NVIC_GetPriorityGrouping(uint32_t* priorityGroup)
{
	NVIC_enuErrorStatus_t LOC_enuErrorStatus = NVIC_enuOk;
